...
$facultyUser = new User('Ivan', 'Bratz', 'Faculty', 'ivanbratsz', 'CCS', 'bratz@dyci.edu.ph');
$user = $login;
...
<body>
          ...
          <div class="col-md-4">
            <div class="card-ghost p-3 qr-card">
              <div class="w-100 d-flex justify-content-between">
                <div><strong>OOP213 - Object-Oriented Porgramming</strong>
                  <div class="small text-muted">BSCS-2A • Ana Lizel</div>
                </div>
                <div><span class="badge bg-success">Active</span></div>
              </div>
              <div class="mt-2">
              ...
              <table class="table mt-2">
                ...
                <tbody id="borrowedList">
                  <tr>
                    ...
                    <td><button class="btn btn-sm btn-success" onclick="markReturned(this)">Mark Returned</button></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <table class="table">
            ...
            <tbody id="equipmentList">
              <tr>
                <td>PC - 01</td>
                <td>Desktop</td>
                <td><span class="badge-status-working">Available & working</span></td>
                <td>2025-11-20</td>
              ...
              <tr>
                <td>Monitor - 02</td>
                <td>Monitor</td>
                <td><span class="badge-status-issue">With Error</span></td>
                <td>2025-11-23</td>
                <td><button class="btn btn-sm btn-outline-secondary">Edit</button></td>
              </tr>
              <tr>
                <td>Printer - Lab</td>
                <td>Peripheral</td>
                <td><span class="badge-status-pulled">Pulled out</span></td>
                <td>2025-11-01</td>
                <td><button class="btn btn-sm btn-outline-secondary">Edit</button></td>
              </tr>
            </tbody>
  ...
  <div class="modal fade" id="borrowModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Borrow Item</h5><button class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <form id="borrowModalForm">
            ...
            <div class="mb-2"><label class="form-label small">Equipment</label><select class="form-select form-select-sm">
                <option>Mouse - USB</option>
  ...
  <div class="modal fade" id="addEquipmentModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Add Equipment</h5><button class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="requestModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">New Request</h5><button class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <form id="newReqForm">
            <div class="mb-2"><label class="form-label small">Type</label><select class="form-select form-select-sm">
                <option>Software Installation</option>
                <option>Purchase</option>
              </select></div>
            <div class="mb-2"><label class="form-label small">Priority</label><select class="form-select form-select-sm">
                <option>Low</option>
                <option>High</option>
              </select></div>
